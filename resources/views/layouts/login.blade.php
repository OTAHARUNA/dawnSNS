...
<body>
    <div id="container" style="display:grid;">
        ...
        <div class="row justify-content-between" id="all">
            <div class="col-10">
                @yield('content')
            </div>


            <div class="col-2" id="sidebar" style=" height:1200px;">
                <div id="confirm">
                    <p class="mt-3"><span class="font-weight-bold">{{ Auth::user()->username }}さんの</span></p>
